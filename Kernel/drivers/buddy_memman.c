...
void b_init(void* start_addr, uint64_t total_size) {
    ...
    // Calculate the start of the allocatable memory region
    // Ensure it's aligned to page boundary
    ...
    // Recalculate available size after alignment
